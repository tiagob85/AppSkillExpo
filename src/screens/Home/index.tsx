...
export function Home() {
  ...
  async function handleSave() {
    //Tudo que for modificar dados(insert, update e delete), utilize o write
    if(skill.id)//Se exsite id, será atualizado a informação.
    {
    ...
    setName('');//limpando o campo após a gravação da informação.
    fetchData();
  }
